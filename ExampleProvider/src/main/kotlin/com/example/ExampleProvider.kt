...
class StreamingcommunityProvider : MainAPI() {
    override var mainUrl = "https://streamingcommunity.estate"
    private var cdnUrl = "https://cdn.streamingcommunity.estate" // Images
...
val soup = app.post(url, json = JSONObject(postData), headers = mapOf("Content-Type" to "application/json")).text
